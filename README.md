...
package beginning with `4.0.0-rc.4`. It is a deliberately thin compatibility
...
After `@vinary-tree/liblevenshtein@4.0.0-rc.4` resolves and passes an
...
verify `next = 4.0.0-rc.4` and `latest = 2.0.4`; unlike the six new scoped
